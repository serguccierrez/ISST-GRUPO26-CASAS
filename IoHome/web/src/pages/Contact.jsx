  ...
  <main>
    <div className="text-container">
      ...
      <p style={{ fontSize: "1.15rem" }}>
        ¿Tienes dudas o necesitas ayuda? Nuestro equipo está aquí para
        asistirte. Contáctanos a través de nuestro formulario o correo
    ...
    <section className="flex items-center justify-between mt-8 w-[85%] mx-auto">
      ...
      <div className="text-container">
        ...
        <p style={{ fontSize: "1.15rem" }}>
          Estamos comprometidos a brindarte el mejor servicio. Aprende cómo
          configurar tus cerraduras inteligentes y aprovecha al máximo nuestras
          soluciones para un hogar más seguro y conectado.
        </p>
        <h2>iohome.company@gmail.com</h2>
      </div>
    </section>
